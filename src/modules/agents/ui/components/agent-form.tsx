        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input {...field} placeholder="Eg. Sports Coach" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea
                  {...field}
                  placeholder="You are an experienced AI sports coach helping athletes improve performance, create personalized training plans, and stay motivated."
                />
              </FormControl>
              <FormMessage />
            </FormItem>
